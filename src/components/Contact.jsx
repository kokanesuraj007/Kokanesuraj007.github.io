...
export const Contact = ({ aboutRef, contactRef }) => {
    ...
    return(
        <Container pt={50} mt={250} borderTop='1px solid gray' ref={contactRef}>
                    ...
                    <SimpleGrid columns={4} spacing={10}>
                        <Popover>
                            ...
                            <PopoverContent>
                                ...
                                <PopoverBody background='white' fontSize={15} p={5} borderRadius='0 0 10px 0'>surajkokane1997@gmail.com</PopoverBody>
                            </PopoverContent>
                        </Popover>
                        <Link href="https://www.linkedin.com/in/suraj-kokane-5ab4a61b1/"
            ...
            <Text color='white' fontSize={12} mt={150}>Created by <strong color='#C668FF'>Suraj Kokane</strong></Text>
